...
const numSamplesPerGesture = 21;
const totalNumDataFiles = numSamplesPerGesture * numClasses;
const numPointsOfData = 6;
const numLinesPerFile = 50;
const totalNumDataPerFile = numPointsOfData * numLinesPerFile;
...
function cleanup() {
    try {
        ...
        tf.disposeVariables();
        console.log('Cleaned up TensorFlow resources');
    } catch (error) {
